...
let n = ""; //randomにおみくじの内容を決定する変数
let nBefore = ""; //前回の変数ｎの値

window.addEventListener("DOMContentLoaded",
    function () {
        //ページ全体が読み込まれたときにタイミングで実行するコード
        // ヘッダーのテキストエフェクト
        $("header").textillate({
            loop: false, // ループのオンオフ
...
btn1.addEventListener("click",
    function () {
        ...
        //おみくじのテキスト画像対応
        omikujiTextImage.src = resultText[n]; //fukuda-add おみくじのテキスト画像対応
